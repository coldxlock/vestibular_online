...
if (isset($_POST['redacao']) && $_POST['redacao'] != '') {
	// caso seja redacao
	$email_usuario = $_SESSION['email'];
	$cod_questao = $_GET['eid'];
	$conteudo_redacao = $_POST['redacao'];

	echo "Salva  redacao ". $email_usuario . " ". $cod_questao;

	$RAM = mysqli_query($con,"INSERT INTO redacao(cod_questao,descricao,email) VALUES  ( '$cod_questao','$conteudo_redacao' ,'$email_usuario')");
...
$ch=@$_GET['ch'];
	...
	$qd=mysqli_query($con,"INSERT INTO options VALUES  ('$qid','$e','$odid')") or die('Error64');
	$f=$_POST['ans'.$i];
	switch($f)
	{
	case 'a':
